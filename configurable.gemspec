...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/generators/configurable/install_generator.rb",
    "lib/generators/configurable/templates/configurable.yml",
    "lib/generators/configurable/templates/migration.rb"
  ]
